...
devhook-cli/2.0.1 darwin-x64 node-v14.15.0
...
_See code: [src/commands/login.js](https://github.com/devhook-io/devhook-cli/blob/v2.0.1/src/commands/login.js)_
...
_See code: [src/commands/monitor.js](https://github.com/devhook-io/devhook-cli/blob/v2.0.1/src/commands/monitor.js)_
<!-- commandsstop -->
